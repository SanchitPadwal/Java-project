	...
	<form action="validate1" method="post">
		<div class="bg-text">
			...
			<div class="form-group">
				<label for="pass" class="control-label col-md-4"><b>Email-Id
						</b></label>
				<div class="col-md-8">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					...
					<div>
						<span class="psw"><a href="#">Forget your password?</a></span>
					</div>
				</div>
			</div>
			<br> <br>
			...
			<div class="w3-container">
				<button type="submit" class="btn btn-success"
					onclick="window.location.href='ownerregistration';">Create
					Account</button>
			</div>
		</div>
	</form>
